package com.schema.registry.tns.demo;
...
public class ConsumerDemoTopicNameStrategy {
	public static void main(String[] args) {
		Properties properties = new Properties();
		// normal consumer
		properties.setProperty("bootstrap.servers","127.0.0.1:9092");
		properties.put("group.id", "user-consumer-group-topic-name-strategy-1");
		...
		String topic = "user-topic-name-strategy-test-1";
