package com.schema.registry.multievents.trns.demo;
...
public class ConsumerDemoTopicRecordNameStrategyME {
	public static void main(String[] args) {
		Properties properties = new Properties();
		// normal consumer
		properties.setProperty("bootstrap.servers","127.0.0.1:9092");
		properties.put("group.id", "mult-event-topic-trns-group");
		...
		String topic = "mult-event-topic-trns";
