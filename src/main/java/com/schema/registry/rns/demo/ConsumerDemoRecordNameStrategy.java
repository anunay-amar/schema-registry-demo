package com.schema.registry.rns.demo;
...
import example.avro.sample2.User;
import io.confluent.kafka.serializers.KafkaAvroDeserializer;

public class ConsumerDemoRecordNameStrategy {
	public static void main(String[] args) {
		Properties properties = new Properties();
		// normal consumer
		properties.setProperty("bootstrap.servers","127.0.0.1:9092");
		properties.put("group.id", "user-consumer-group-record-name-strategy-1");
		...
		String topic = "user-record-name-strategy-test-1";
